...
public class Update extends Basepage{
    ...
    public void cleanArticleBox(){
        Helper.pause(3);
        cleanThis(writeArticleBox);}
    public void enterNewArticle(String newArticle){
        Helper.pause(2);
        type(writeArticleBox, newArticle);}
    public void cleanTagsBox(){
        Helper.pause(2);
        cleanThis(tagsBox);}
